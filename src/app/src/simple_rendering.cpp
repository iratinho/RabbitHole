...
namespace app::renderer {
    ...
    bool SimpleRendering::CreateRenderingBuffers() {
        ...
        // Staging buffer
        {
            ...
            int memory_type_index = render_context_->FindMemoryTypeIndex(VK_MEMORY_PROPERTY_HOST_COHERENT_BIT | VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT, memory_requirements);
        ...
        // device local buffer
        {
            ...
            int memory_type_index = render_context_->FindMemoryTypeIndex(VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, memory_requirements);
